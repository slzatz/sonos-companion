...
from cayenne_config import client_id, mqtt_username, mqtt_password, mqtt_server
import csv
...
def sales_forecast():
    ...
    mqtt_publish.single('esp_tft', json.dumps(data), client_id=client_id, hostname=mqtt_server, retain=False, port=1883, keepalive=60, auth={"username":mqtt_username, "password":mqtt_password})
