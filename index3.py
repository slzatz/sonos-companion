#@+leo-ver=5-thin
#@+node:slzatz.20140105160722.1551: * @file C:/home/slzatz/webapp/index3.py
#@@language python
#@@tabwidth -4
#@+others
...
def get_lyrics(url):
    ...
    if not url:
        return "Can't find lyrics - url had 'edit' "
...
def index():
    track = sonos.get_current_track_info()
    return render_template('index3.html', track=track)
